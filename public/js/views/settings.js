...
export async function renderSettings() {
  ...
  return {
    html: `
      ...
      <section class="grid-2 maintenance-grid">
        ${sectionCard('Interne REST API', `<p>Leesacties en schrijfacties gebruiken afzonderlijke paden. Een reverse proxy kan daardoor <strong>/api/write/</strong> uitsluitend binnen het LAN toelaten.</p><div class="api-list"><div class="api-endpoint">GET /api/read/cards/search?q=eternal</div><div class="api-endpoint">GET /api/read/collection</div><div class="api-endpoint">GET /api/read/decks/:id/stats</div><div class="api-endpoint">GET /api/read/wanted</div><div class="api-endpoint">POST /api/write/collection</div><div class="api-endpoint">PATCH /api/write/wanted/:id/printing</div><div class="api-endpoint">POST /api/write/maintenance/external-cache/clear</div></div>`)}
